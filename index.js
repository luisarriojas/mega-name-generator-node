...
var adjetives = require("./adjetives.js");
var nouns = require("./nouns.js");

console.log(adjetives.items[Math.floor(Math.random() * adjetives.items.length)] + " " + nouns.items[Math.floor(Math.random() * nouns.items.length)]);